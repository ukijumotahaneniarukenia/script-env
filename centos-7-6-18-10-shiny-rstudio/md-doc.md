...
```
time docker build -t centos-7-6-18-10-shiny-rstudio --build-arg GIT_VERSION=2-24-1 --build-arg PYTHON_VERSION=3-7-4 --build-arg RSTUDIO_VERSION=1-2-VVV --build-arg R_VERSION=X-X-X --build-arg SHINY_VERSION=1-5-9 --build-arg REPO=script-repo --build-arg APP_NAME=shiny-rstudio --build-arg OS_VERSION=$(echo centos-7-6-18-10-shiny-rstudio | grep -Po '[a-z]{1,}(?:-[0-9]{1,}){1,}') . UNKO
```
...
```
time docker build --no-cache -t centos-7-6-18-10-shiny-rstudio --build-arg GIT_VERSION=2-24-1 --build-arg PYTHON_VERSION=3-7-4 --build-arg RSTUDIO_VERSION=1-2-VVV --build-arg R_VERSION=X-X-X --build-arg SHINY_VERSION=1-5-9 --build-arg REPO=script-repo --build-arg APP_NAME=shiny-rstudio --build-arg OS_VERSION=$(echo centos-7-6-18-10-shiny-rstudio | grep -Po '[a-z]{1,}(?:-[0-9]{1,}){1,}') . | tee log
```
