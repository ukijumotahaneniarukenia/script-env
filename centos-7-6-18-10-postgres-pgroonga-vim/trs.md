...
- 原因
  ...
  - ビルドオプションで指定したパッケージエントリディレクトリとライブラリディレクトリが異なる
...
- 対応
  ...
  - ビルドオプションで指定したパッケージエントリディレクトリとライブラリディレクトリを揃える

- 予防

  - ビルドオプションを確認するコマンドを調べる
...
- 原因
  ...
  - ダイナミックリンクファイルのリンカが切れている

- 対応

  - プログラム単位でダイナミックリンクファイルが存在しているディレクトリをシステムに認識させ、キャッシュを事前に作成しておく
