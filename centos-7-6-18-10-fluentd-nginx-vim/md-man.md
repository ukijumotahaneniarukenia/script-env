...
```
time docker build -t centos_centos-7-6-18-10-fluentd . | tee log
```

# dockerコンテナ起動

```
docker run --privileged -itd --name centos-7-6-18-10-fluentd -v /sys/fs/cgroup:/sys/fs/cgroup:ro -p 8080:80 centos-7-6-18-10-fluentd
```
