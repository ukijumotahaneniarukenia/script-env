# 参考文献
https://qiita.com/MuuKojima/items/afc0ad8309ba9c5ed5ee </br>
...
# dockerコンテナ起動
```
docker run --privileged -v /sys/fs/cgroup:/sys/fs/cgroup:ro -itd --name nginx -p 8080:80 centos-7-6-18-10-nginx
```
